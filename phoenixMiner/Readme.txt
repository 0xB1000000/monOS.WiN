PhoenixMiner 2.9e Documentation
===============================
...
the future but it will take some time.
...
Mining options:
  ...
  -mi <n> Set the mining intensity (0 to 14; 12 is the default for new kernels)
  ...
  -nvf <n> Nvidia kernel sync (0: never, 1: periodic; 2: always; default: 1)
